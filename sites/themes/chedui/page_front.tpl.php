<?php include "header.tpl.php";?>
		<div id="banner">
				<div id="play">
					...
					<div id="play_list">
					<?php $data = article_list('',0,4,'s');if($data){foreach($data as $val){?>
					...
					<div id="play_text">
						...
						<?php if($data){foreach($data as $val){?>
						 <li><img src="<?php echo get_litpic($val,'80x54');?>" title="<?php echo $val->title;?>" alt="<?php echo $val->title;?>" /></li>
						<?php }};?>
						</ul>
					 </div>
				  </div>
				...
				<div class="guandian">
					...
					<?php $data = article_list('', 20, 3);if($data){foreach($data as $key=>$val){$middle = '';if($key == 1){$middle = 'middle';};?>
						<div class="rwblock <?php echo $middle;?>">
							<div class="rwtitle">
								<div class="rwpic"><a href="<?php echo $val->url;?>"><img src="<?php echo get_litpic($val);?>" width="50" height="50" /></a></div>
            ...
            <div class="fcon">
							...
							<div class="item-list">
								...
								<?php $data = article_list('', 16, 4);if($data){foreach($data as $key=>$val){;?>
									<li><div class="litpic"><a href="<?php echo $val->url;?>"><img src="<?php echo get_litpic($val, '260x180');?>" title="<?php echo $val->title;?>" width="140" height="96" /></a></div><h3><a href="<?php echo $val->url;?>"><?php echo $val->title;?></a><div class="entitle"><?php echo $val->ename;?></div></h3><div class="des"><?php echo $val->description;?></div></li>
								<?php }};?>
								<ul>
							</div>
						</div>
					...
					<div class="frontright">
						...
						<div class="block tags">
							<h1 class="newst">网友热评</h1>
							<div class="content">
							<?php $data = article_list('', 20, 1);if($data){foreach($data as $key=>$val){;?>
									<h3><a href="<?php echo $val->url;?>"><?php echo $val->title;?></a><div class="entitle"><?php echo $val->ename;?></div></h3><div class="des"><?php echo $val->description;?>[详细]</div>
								<?php }};?>
							</div>
						</div>
					</div>
