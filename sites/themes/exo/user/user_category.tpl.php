...
;?>
		<div class="front_term_list <?php echo $class;?>">
			...
			<div class="fcon_right">
				<div class="jieshao"><?php $art = db_query("SELECT nid,title FROM {article} WHERE uid = ?", array($val->uid), array('return' => 'one'));if($art){;?><a href="<?php echo $art->url;?>"><?php echo $art->title;?></a><?php };?></div>
				<!--
				<div class="ftags">
...
<div class="pguandian_right">
						...
						<div class="block remen">
							...
							<?php $data = article_list('', 0, 5);if($data){foreach($data as $key=>$val){;?>
